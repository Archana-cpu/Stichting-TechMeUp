...
# █                                                                            █
# █                              SECTION 31                                    █
# █              CRITICAL CLARIFICATIONS & FINAL DECISIONS                     █
# █                                                                            █
# ██████████████████████████████████████████████████████████████████████████████

# Version: 1.0.0
# Created: January 2026
# Purpose: Resolves all ambiguities identified in bible audit before implementation
...
# ══════════════════════════════════════════════════════════════════════════════
# 31.1 QUALITY SCORE TERMINOLOGY CLARIFICATION
# ══════════════════════════════════════════════════════════════════════════════
...
## 31.1.2 Resolution: Two Different Concepts
...
## 31.1.3 Official Terminology (P-055)
...
# ══════════════════════════════════════════════════════════════════════════════
# 31.2 REAL-TIME TECHNOLOGY DECISION
# ══════════════════════════════════════════════════════════════════════════════

## 31.2.1 Final Decision (P-056)
...
# ══════════════════════════════════════════════════════════════════════════════
# 31.3 DEVICE FINGERPRINT CONFIRMATION
# ══════════════════════════════════════════════════════════════════════════════

## 31.3.1 Confirmation (P-057)
...
# ══════════════════════════════════════════════════════════════════════════════
# 31.4 RATE LIMITING THRESHOLDS
# ══════════════════════════════════════════════════════════════════════════════

## 31.4.1 Complete Rate Limit Specification (P-058)
...
## 31.4.2 Rate Limit Response Format
...
# ══════════════════════════════════════════════════════════════════════════════
# 31.5 ERROR MESSAGE SANITIZATION
# ══════════════════════════════════════════════════════════════════════════════
...
│                                                                                 │
│  BAD EXAMPLE:                                                                   │
│  "Tamamlama süresi beklenenin %15'i. Minimum %20 gerekli."                     │
...
## 31.5.2 Resolution: Sanitized Error Messages (P-059)
...
// ❌ BAD
"Yanıt süreniz çok kısa (12 saniye). Minimum 30 saniye gerekli."

// ✅ GOOD
"Yanıtınız beklenenden hızlı tamamlandı. Lütfen soruları dikkatli okuyun."
...
// ❌ BAD
"Kalite puanınız 35/100. Minimum 40 gerekli."

// ✅ GOOD
"Yanıtlarınızda tutarsızlık tespit edildi. Lütfen dikkatlice cevaplayın."
...
// ❌ BAD
"Aynı cihazdan daha önce oy kullanıldı."
...
// ❌ BAD
"Tüm sorulara aynı seçeneği işaretlediniz (straight-lining tespit edildi)."

// ✅ GOOD
"Yanıt kalitesi yeterli değil. Lütfen her soruyu ayrı değerlendirin."
...
export const SANITIZED_ERRORS = {
  ...
  RESPONSE_TOO_FAST: "Yanıtınız beklenenden hızlı tamamlandı. Soruları dikkatli okuduğunuzdan emin olun.",
  RESPONSE_TOO_SLOW: "Yanıt süresi doldu. Lütfen tekrar deneyin.",
  RESPONSE_INCONSISTENT: "Yanıtlarınızda tutarsızlık tespit edildi.",
  RESPONSE_LOW_QUALITY: "Yanıt kalitesi yeterli değil. Lütfen soruları dikkatle cevaplayın.",

  // Attention Check Failures
  ATTENTION_CHECK_FAILED: "Kontrol sorusunu yanlış cevapladınız. Lütfen soruları dikkatli okuyun.",

  // Duplicate Attempts
  ALREADY_PARTICIPATED: "Bu ankete/oylamaya zaten katıldınız.",
  DUPLICATE_DEVICE: "Bu cihazdan zaten katılım yapıldı.",

  // Pre-test Failures
  PRETEST_FAILED: "Ön test başarısız. Konuyu daha iyi anlayarak tekrar deneyebilirsiniz.",
  PRETEST_COOLDOWN: "Çok fazla başarısız deneme. Daha sonra tekrar deneyin.",

  // Rate Limiting
  TOO_MANY_ATTEMPTS: "Çok fazla deneme yaptınız. Lütfen biraz bekleyin.",

  // Fraud Detection (generic)
  SUBMISSION_REJECTED: "Yanıtınız kabul edilemedi. Lütfen daha sonra tekrar deneyin.",
  SUSPICIOUS_ACTIVITY: "Olağandışı aktivite tespit edildi. Destek ile iletişime geçin.",

  // Account Issues
  ACCOUNT_RESTRICTED: "Hesabınız geçici olarak kısıtlandı.",
}
...
# ══════════════════════════════════════════════════════════════════════════════
# 31.6 PLUS TIER PULSE/COMMENTS CLARIFICATION
# ══════════════════════════════════════════════════════════════════════════════

## 31.6.1 Plus Tier Exact Capabilities (P-060)
...
| View PULSE | ❌ | ✅ | ✅ | ✅ | ✅ |
| Read Comments | ❌ | ✅ | ✅ | ✅ | ✅ |
| Write Comments | ❌ | Request Required | ❌ | ✅ | ✅ |
...
- [ ] Rate limit middleware configured with values from §31.4.1
- [ ] Error messages use sanitized versions from §31.5.2
