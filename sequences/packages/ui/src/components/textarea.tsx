...
export function Textarea({ className, ...props }: TextareaProps) {
  return (
    <div className="relative group">
      <textarea
        className={cn(
          'flex min-h-[120px] w-full rounded-xl border-2 border-border/50 bg-background/60 backdrop-blur-md px-5 py-4 text-sm ring-offset-background placeholder:text-muted-foreground/50 focus-visible:outline-none focus-visible:border-primary focus-visible:bg-background focus-visible:ring-4 focus-visible:ring-primary/20 focus-visible:ring-offset-2 focus-visible:shadow-xl focus-visible:shadow-primary/20 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-300 ease-out resize-none vintage-input',
